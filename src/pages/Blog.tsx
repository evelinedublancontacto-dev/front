...
const categories = ["Todos", ...Object.values(CATEGORY_MAP)];
...
const categoryColors: Record<string, string> = {
  ...
  "Cristales y Cuarzos": "bg-gold/15 text-gold",
};
      ...
      <section className="relative pt-24 pb-32 overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div
            ...
            style={{
              background: "linear-gradient(180deg, hsla(270,30%,12%,0.7) 0%, hsla(270,30%,12%,0.85) 100%)",
            }}
          />
        </div>
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          >
            ...
            <span className="font-body text-sm tracking-[0.25em] uppercase" style={{ color: "hsl(42 70% 62%)" }}>
          ...
          >
            Artículos sobre psicoterapia, meditación, sanación energética y herramientas para tu bienestar integral.
          </motion.p>
        </div>
                      ...
                      <div className="absolute top-4 left-4">
                        <span
                          className={`px-3 py-1 rounded-full text-xs font-body font-semibold ${
                            categoryColors[catLabel] ?? "bg-muted text-muted-foreground"
                          }`}
                        >
                          {catLabel}
                        </span>
