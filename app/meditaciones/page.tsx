    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-32 pb-24 overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/assets/meditaciones-hero.jpg" alt="Meditaciones" className="w-full h-full object-cover" width={1920} height={1080} />
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <motion.div animate={{ y: [-5, 8, -5], rotate: [0, 15, 0] }} transition={{ duration: 9, repeat: Infinity, ease: "easeInOut", delay: 1.5 }} className="absolute top-16 left-[65%]">
            <svg width="32" height="28" viewBox="0 0 32 28" fill="none">
              <path d="M16 2L30 26H2L16 2Z" stroke="hsla(42, 70%, 62%, 0.25)" strokeWidth="2" />
            </svg>
          </motion.div>
          <motion.div animate={{ rotate: [45, 225, 45], scale: [1, 1.1, 1] }} transition={{ duration: 15, repeat: Infinity, ease: "easeInOut" }} className="absolute bottom-24 left-[15%] w-12 h-12 border-2" style={{ borderColor: "hsla(42, 70%, 62%, 0.25)", transform: "rotate(45deg)" }} />
          <motion.div animate={{ x: [-10, 10, -10] }} transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }} className="absolute bottom-36 left-[5%]">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }}>
            <div className="w-20 h-20 rounded-2xl bg-white/10 backdrop-blur-sm flex items-center justify-center mx-auto mb-6 border border-white/20 shadow-mystical">
              <Image
                src="/assets/icons/services/meditaciones.svg"
                alt="Meditaciones"
                width={48}
                height={48}
          ...
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="font-display text-5xl md:text-7xl font-bold mb-4" style={{ color: "hsl(0 0% 100%)" }}>Meditaciones</motion.h1>
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.35 }} className="font-body text-lg md:text-xl max-w-2xl mx-auto" style={{ color: "hsla(0, 0%, 100%, 0.75)" }}>
