    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-32 pb-24 overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/assets/sesion-cumpleanos-hero.jpg" alt="Sesión de Cumpleaños" className="w-full h-full object-cover" width={1920} height={1080} />
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0} variants={fadeUp}>
                <Image src="/assets/sesion-cumpleanos.jpg" alt="Sesión de cumpleaños" className="rounded-2xl shadow-2xl w-full object-cover aspect-[3/4]" width={600} height={800} />
              </motion.div>
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0} variants={fadeUp} className="mb-20">
              ...
              <div className="grid sm:grid-cols-2 gap-6 max-w-4xl mx-auto">
                {[
                  ...
                  { icon: Heart, title: "Lectura de Oráculo con Ángeles", desc: "Identifica el clima energético de tu año para saber cómo aprovecharlo." },
