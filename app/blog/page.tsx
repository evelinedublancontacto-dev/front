...
const Blog = () => {
  ...
  const filtered =
    activeCategory === "Todos"
      ? posts
      : posts.filter((p) => CATEGORY_MAP[p.category] === activeCategory);
                    ...
                    <div className="h-48 relative overflow-hidden">
                      {post.image ? (
                        ...
                        <div
                          ...
                          style={{
                            background:
                              "linear-gradient(135deg, hsl(var(--primary) / 0.15), hsl(var(--gold) / 0.1))",
                          }}
                        >
                          <Sparkles
                      ...
                      <div className="absolute top-4 left-4">
                        <span
                          className={`px-3 py-1 rounded-full text-xs font-body font-semibold ${categoryColors[catLabel] ?? "bg-muted text-muted-foreground"}`}
                        >
                          {catLabel}
                        </span>
                      </div>
